...
namespace TimeScripts
{
    ...
    public class TimeBonus : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                if (GameManager.GameManager.Instance.LevelGoal.levelCounter == LevelCounter.Moves)
                {
                    bonusValue = 0;
                }
            }
        ...
        void SetupMaterial(int value, GameObject mBonusGlow)
        {
            ...
            if (bonusMaterials[clampedValue] != null)
            {
                if (mBonusGlow != null)
                {
                    ParticleSystemRenderer bonusGlowRenderer = mBonusGlow.GetComponent<ParticleSystemRenderer>();
